...
export const EVENTS = [
{
  slug: "gita-festival-coventry",

  name: "Gita Festival Coventry",

  tagline:
    "An Evening of Devotion, Wisdom & Fellowship",

  shortDesc:
    "Join us for an inspiring evening of devotion, bhajans, spiritual discourse, and fellowship as we come together to celebrate the timeless wisdom of the Bhagavad Gita in the divine presence of Pujya Gurudev HH Gita Manishi Swami Shri Gyananand Ji Maharaj.",

  heroImage: "/22aug.jpeg",
  ...
  body: [
    "Join us for a spiritually uplifting evening dedicated to the timeless wisdom of the Bhagavad Gita.",
    "The programme begins with soulful bhajans, creating an atmosphere of devotion and divine remembrance.",
    "Pujya Gurudev HH Gita Manishi Swami Shri Gyananand Ji Maharaj will then deliver an inspiring discourse, sharing practical guidance from the Bhagavad Gita for everyday life.",
    "The evening concludes with Priti Bhojan, offering devotees an opportunity to enjoy prasadam and spend time together in an atmosphere of love, unity and fellowship.",
    "Everyone is warmly invited to attend with family and friends."
  ],

   highlights: [
    "Soulful Bhajans",
    "Spiritual Discourse by Pujya Gurudev",
    "Bhagavad Gita teachings for daily life",
    "Darshan and Satsang",
    "Priti Bhojan (Prasadam)",
    "An evening of devotion and fellowship"
  ],
  ...
  faqs: [
    {
      ...
      answer: "No registration is required. Everyone is welcome."
    },
    {
      question: "Is there any entry fee?",
      answer: "No. The programme is open to all free of charge."
    },
    {
      question: "Will Priti Bhojan be served?",
      answer: "Yes. Priti Bhojan (Prasadam) will be served after the discourse."
    }
  ],

  closingMessage:
    "Join us for a beautiful evening of bhajans, spiritual wisdom and fellowship as we celebrate the eternal message of the Bhagavad Gita in Coventry.",

  registrationLink: "",

  seoDescription:
    "Join Gita Festival Coventry on Saturday, 22 August 2026 at 380 Stoney Stanton Rd, Coventry, CV6 5DJ, England. The programme includes Bhajans at 6:30 PM, Spiritual Discourse at 7:00 PM by Pujya Gurudev HH Gita Manishi Swami Shri Gyananand Ji Maharaj, followed by Priti Bhojan."
},
{
  slug: "gita-festival-london",
  name: "Gita Festival London",
  tagline: "Spiritual Wisdom, Timeless Values, Global Harmony",
  shortDesc:
    "Join us for an inspiring evening with Pujya Gurudev HH Gita Manishi Swami Shri Gyananand Ji Maharaj in London, featuring devotional Satsang, Gita wisdom, cultural performances and an opportunity for Darshan of Maharaji.",

  heroImage: "/23aug.jpeg",
  ...
  body: [
    "Join us for an inspiring evening with Pujya Gurudev HH Gita Manishi Swami Shri Gyananand Ji Maharaj at Shree Ram Mandir in Southall, London.",
    "The evening will celebrate the timeless wisdom of the Bhagavad Gita, bringing together devotees for an atmosphere of devotion, reflection and fellowship.",
    "The programme will include soulful Satsang, cultural performances, and an inspiring discourse by Pujya Gurudev, sharing the eternal teachings of the Gita for everyday life.",
    "There will be an opportunity for Darshan of Maharaji. Everyone is warmly welcome to join with family and friends."
  ],

  highlights: [
    "Gita Wisdom",
    "Satsang with Pujya Gurudev HH Gita Manishi Swami Shri Gyananand Ji Maharaj",
    "Cultural Program",
    "Darshan of Maharaji",
  ...
  itinerary: [
    ...
    {
      time: "7:00 PM",
      title: "Discourse by Pujya Gurudev HH Gita Manishi Swami Shri Gyananand Ji Maharaj"
    },
    {
      time: "8:00 PM onwards",
      title: "Darshan of Maharaji"
    }
  ],
  ...
  faqs: [
    {
      question: "Do I need to register?",
      answer: "No registration is required. Everyone is warmly welcome to join."
    },
    {
      question: "Is there any entry fee?",
      answer: "No. The programme is open to all free of charge."
    ...
    {
      question: "Will there be an opportunity for Darshan?",
      answer: "Yes. There will be an opportunity for Darshan of Maharaji during the evening."
    }
  ],

  closingMessage:
    "Join us for a beautiful evening of Gita wisdom, Satsang and cultural celebration in the divine presence of Pujya Gurudev HH Gita Manishi Swami Shri Gyananand Ji Maharaj in London.",

  registrationLink: "",

  seoDescription:
    "Join Gita Festival London on Sunday, 23 August 2026 at Shree Ram Mandir, 22 King St, Southall, London from 6:00 PM onwards. Experience Gita wisdom, Satsang, cultural performances and Darshan of Pujya Gurudev HH Gita Manishi Swami Shri Gyananand Ji Maharaj."
},
  {
  ...
  coachTravel: {
    ...
    departure:
      "5:00 PM from Gita Bhavan Hindu Temple, 231 Withington Road, Manchester",
...
programme: [
  ...
  },
  {
    ...
    title: "Devotional Bhajans & Arrival of Pujya Gurudev HH Gita Manishi Swami Shri Gyananand Ji Maharaj"
  },
